...
source.include_exts = py,png,jpg,kv,txt,atlas,number
...
requirements = python3==3.7.6,hostpython3==3.7.6,kivy==2.1.0,kivymd==0.104.2, sdl2_ttf==2.0.15, aidl, pillow==8.3.1
